...
export default {
  ...
  watch: {
    areaLegend: {
      handler(val) {
        const lineChartComponent = this.$refs.userAttendanceChart;
...
<template>
  <div class="chart">
    ...
    <div class="chart__user-projects">
      ...
      <span class="chart__user-projects__item">Office visit</span>
    </div>
  </div>
</template>
